...
namespace Alma\Client\Tests\Unit\Application\Helper;

use Alma\Client\Application\Exception\MissingKeyException;
use Alma\Client\Application\Exception\ParametersException;
use Alma\Client\Application\Helper\ArrayHelper;
...
class ArrayTest extends MockeryTestCase
{
    ...
    {
        if ($expected === 'Alma\Client\Application\Exception\ParametersException') {
